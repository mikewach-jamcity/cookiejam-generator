...
(function () {
    ...
    NetManager.prototype._hasEnabledAssets = false;
    NetManager.prototype._hasEnabledLayout = false;
    NetManager.prototype._hasEnabledWrapper = false;
    NetManager.prototype._hasEnabledAtlas = false;
    NetManager.prototype._hasBakingAssets = false;
    NetManager.prototype._hasBakingLayout = false;
    NetManager.prototype._hasBakingWrapper = false;
    NetManager.prototype._hasBakingAtlas = false;
    ...
    function NetManager(logger, stateManager, documentManager, renderManager) {
        ...
        this._hasEnabledAssets = this._stateManager.enabled;
    ...
    NetManager.prototype._handleClientConnection = function(socket) {
        ...
        var sendStatus = (function() {
            ...
            // assets status
            status.assets = this._hasDocuments ? this._hasEnabledAssets ? this._hasBakingAssets ? "active" 
                                                                                                : "idle" 
                                                                        : "disabled"
                                               : "document_null";
            // layout status
            status.layout = this._hasDocuments ? this._hasEnabledLayout ? this._hasBakingLayout ? "active" 
                                                                                                : "idle" 
                                                                        : "disabled"
                                               : "document_null";
            // wrapper status
            status.wrapper = this._hasDocuments ? this._hasEnabledWrapper ? this._hasBakingWrapper ? "active" 
                                                                                                   : "idle" 
                                                                          : "disabled"
                                                : "document_null";
            // atlas status
            status.atlas = this._hasDocuments ? this._hasEnabledAtlas ? this._hasBakingAtlas ? "active" 
                                                                                             : "idle" 
                                                                      : "disabled"
                                              : "document_null";
